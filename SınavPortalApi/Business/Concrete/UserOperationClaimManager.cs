...
namespace Business.Concrete
{
    public class UserOperationClaimManager  : IUserOperationClaimService
    {
        ...
        public IListDataResult<UserOperationClaimDto> GetUserDtoOperationClaims()
        {
            return new SuccessListDataResult<UserOperationClaimDto>(UserOperationClaimDal.GetDtos());
        }

        public IListDataResult<UserOperationClaimDto> GetDtoByUserEmail(string userEmail)
        {
            return new SuccessListDataResult<UserOperationClaimDto>(UserOperationClaimDal.GetDtos(u => u.UserEmail == userEmail));
        }
    }
}
