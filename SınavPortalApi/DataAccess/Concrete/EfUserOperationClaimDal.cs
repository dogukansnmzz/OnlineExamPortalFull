...
{
    public class EfUserOperationClaimDal : EfEntityRepositoryBase<UserOperationClaim, SınavPortalDb>, IUserOperationClaimDal
    {
        public List<UserOperationClaimDto> GetDtoUserOperationClaims(User user)
        {
            using (SınavPortalDb context = new SınavPortalDb())
            {
